@extends('layouts.app')
@section('content')
@section('title' , "بحث كشف حساب موردين")
<div class="row">
   <div class="col-lg-12">
  
      <div class="card">
         <div class="card-header">
            <h5 class="card-title mb-0"> بحث كشف حساب موردين </h5>
         </div>
         <div class="card-body">
            <form action="{{route('site.accounts_statement_suppliers_view')}}" method="POST" autocomplete="off">
               @csrf
