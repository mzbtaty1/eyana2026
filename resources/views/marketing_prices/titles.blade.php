               ...
               <tbody>
                  ...
                  <tr>
                     ...
                     <td>
                        ...
                        <a href="#Removeairline" onclick="Removeairline({{$title->id}})">
...
function Removeairline(id){
      ...
      swal({
     title: "هل انت متأكد؟",
     text: "سيتم حذف ذلك البيان وازالة كل البيانات المرتبطه به",
     icon: "warning",
     buttons: true,
     dangerMode: true,
   })
   ...
   var url = "{{url('')}}/marketing-prices/titles/" + id + "/remove";
//                     alert(url);
