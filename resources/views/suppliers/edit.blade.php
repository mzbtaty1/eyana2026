...
-->
               ...
               <div class="row">
                  <div class="col-md-6 mb-3">
                     ...
                     <input type="text" name="debit_opening_balance" inputmode="decimal" oninput="this.value = this.value.replace(/[^0-9.\-]+/g, '')" value="{{old('debit_opening_balance', $supplier->debit_opening_balance)}}" placeholder="" class="form-control @error('debit_opening_balance') is-invalid @enderror" required="">
                  ...
                  <div class="col-md-6 mb-3">
                     ...
                     <input type="text" name="opening_credit_balance" inputmode="decimal" oninput="this.value = this.value.replace(/[^0-9.\-]+/g, '')" value="{{old('opening_credit_balance', $supplier->opening_credit_balance)}}" placeholder="" class="form-control @error('opening_credit_balance') is-invalid @enderror" required>
