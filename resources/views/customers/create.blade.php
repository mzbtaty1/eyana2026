   ...
   <div class="col-lg-12">
      ...
      <div class="card">
         <div class="card-header">
            <h5 class="card-title mb-0"> اضافة عميل جديد </h5>
         </div>
         <div class="card-body">
            <form action="{{route('site.customers_save')}}" method="POST" autocomplete="off">
               ...
               <div class="row">
                  <div class="col-6 mb-3">
                    ...
                    اسم العميل
                     ...
                     <input type="text" name="name" value="{{old('name')}}" placeholder="اسم العميل" class="form-control @error('name') is-invalid @enderror" style="text-align:right;" required="">
               ...
               <div class="row">
                  <div class="col-6 mb-3">
                     ...
                     <input type="text" name="passport_id" value="{{old('passport_id')}}" placeholder="رقم الباسبور" class="form-control @error('passport_id') is-invalid @enderror" style="text-align:right;">
                  ...
                  <div class="col-6">
                     ...
                     <input type="date" name="passport_expiration_date" value="{{old('passport_expiration_date')}}" placeholder="تاريخ انتهاء الباسبور" class="form-control @error('passport_expiration_date') is-invalid @enderror" style="text-align:right;">
