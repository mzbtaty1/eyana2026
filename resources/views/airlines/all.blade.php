   ...
   <div class="col-lg-12">
      ...
      <div class="card">
         <div class="card-header">
            <h5 class="card-title mb-0">قائمة خطوط الطيران</h5>
               ...
               <tbody>
                  ...
                  <tr>
                     ...
                     <td>
                        ...
                        <a href="#Removeairline" onclick="Removeairline({{$airline->id}})">
...
function Removeairline(id){
      ...
      swal({
     title: "هل انت متأكد؟",
     text: "سيتم حذف ذلك خط الطيران وازالة كل البيانات المرتبطه به",
     icon: "warning",
     buttons: true,
     dangerMode: true,
   })
   ...
   var url = "{{url('')}}/airlines/" + id + "/delete";
//                     alert(url);
