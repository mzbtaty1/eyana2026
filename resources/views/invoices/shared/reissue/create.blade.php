@extends('layouts.app')
@section('content')
@section('title' , "اعادة اصادر / تعديل فاتورة المشتركة")
<style>
    .aler_error{
   ...
   <div class="col-lg-12">
      <div class="card">
         <div class="card-header">
            <h5 class="card-title mb-0"> اعادة اصادر / تعديل فاتورة المشتركة : <b>{{$invoice_info->es_id}}</b> </h5>
         </div>
         <div class="card-body">
            <form action="{{route('site.shared_invoices_reissue_save')}}" method="POST" autocomplete="off" enctype="multipart/form-data">
               @csrf
             ...
             @endif
               ...
               <div class="d-grid gap-2">
                  ...
                  <i class="ri-save-line"></i>
                     اعادة اصادر / تعديل فاتورة المشتركة : <b>{{$invoice_info->es_id}}</b>
                  </button>
