...
<div class="row">
 ...
 <select class="form-select" name="main_storage" required>
     ...
     <option value="{{$storage->id}}" @if($storage->id == $storage_info->main_storage) selected="" @endif>{{$storage->name}}</option>
     @endforeach
                </select>                  
                <br>
                <p>
                ...
                <rtag>(*)</rtag>    
                     ...
                     <input type="text" name="name" value="{{$storage_info->name}}" placeholder="اسم الخزنة" class="form-control" style="text-align:right;" required="">
